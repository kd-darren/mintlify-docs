...
<Note>Please note that the signature is only valid for 5 minutes.</Note>

### About System Time Zone
The system time zone is consistent with the bank time zone, which is Hong Kong Time GMT+0800.
